...
export const asJurasDaChama: Exercise[] = [
  {
    ...
    difficulty: 1,
    statement:
      'Sejam $A$ e $B$ dois eventos disjuntos com $P(A) = 0{,}3$ e $P(B) = 0{,}5$. Qual o valor de $P(A \\cup B)$?',
  ...
  },
  {
    ...
    difficulty: 1,
    statement:
      'Mesmos eventos $A$ e $B$ disjuntos, com $P(A) = 0{,}3$ e $P(B) = 0{,}5$. Qual o valor de $P(A \\cap B)$?',
  ...
  },
  {
    ...
    difficulty: 2,
    statement:
      'Mesmos $A$ e $B$ disjuntos, $P(A) = 0{,}3$ e $P(B) = 0{,}5$. Qual o valor de $P(A \\setminus B)$, isto é, "A acontece e B não acontece"?',
  ...
  },
  {
    ...
    difficulty: 2,
    statement:
      'Aurora visível e vento-norte cortante são eventos disjuntos numa dada noite, com $P(\\text{aurora}) = 0{,}3$ e $P(\\text{vento}) = 0{,}5$. Qual a probabilidade de a noite não trazer nem aurora nem vento?',
  ...
  },
  {
    ...
    difficulty: 2,
    statement:
      'Para uma amostra de água-de-poça, sabe-se que $P(\\text{tocada}) = 0{,}4$, $P(\\text{noite}) = 0{,}6$ e $P(\\text{tocada} \\cup \\text{noite}) = 0{,}8$. Qual o valor de $P(\\text{tocada} \\cap \\text{noite})$?',
  ...
  },
  {
    ...
    difficulty: 3,
    statement:
      'Mesma amostra: $P(\\text{tocada}) = 0{,}4$, $P(\\text{noite}) = 0{,}6$, $P(\\text{tocada} \\cap \\text{noite}) = 0{,}2$. Qual a probabilidade de a amostra ser tocada mas não ter sido coletada à noite?',
    options: ['0,1', '0,2', '0,3', '0,4'],
    correctIndex: 1,
    solution:
  ...
  },
  {
    ...
    difficulty: 2,
    statement:
      'Se $P(E) = 0{,}4$, qual o valor de $P(E^c)$?',
  ...
  },
  {
    ...
    difficulty: 4,
    statement:
      'A Mestra observa três sinais ao longo da noite: $I$, $II$ e $III$. Sabe-se: $P(I) = 0{,}5$, $P(II) = 0{,}4$, $P(III) = 0{,}3$, $P(I \\cap II) = 0{,}2$, $P(I \\cap III) = 0{,}1$, $P(II \\cap III) = 0{,}1$, $P(I \\cap II \\cap III) = 0{,}05$. Qual o valor de $P(I \\cup II \\cup III)$?',
  ...
  },
  {
    ...
    difficulty: 4,
    statement:
      'Um aprendiz escreve, para dois eventos $A$ e $B$: $P(A) = 0{,}7$ e $P(A \\cap B) = 0{,}8$. Qual jura da brasa este escrito viola?',
    options: [
      'A1: probabilidades fora de $[0, 1]$ — pois $0{,}8 > 0{,}7 = P(A)$.',
      'A1: a monotonicidade exige $P(A \\cap B) \\leq P(A)$; $0{,}8 \\leq 0{,}7$ é falso.',
